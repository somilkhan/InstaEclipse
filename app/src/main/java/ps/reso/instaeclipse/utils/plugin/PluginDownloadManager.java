...
public final class PluginDownloadManager {
    ...
    public static void downloadAndQueue(Context context, String id, String version, String packageName,
        ...
        launchInstaller(context, target, id, version, packageName, sha256);
    }
    ...
    private static void launchInstaller(Context context, File file, String id, String version,
                                        String packageName, String sha256) {
        try {
            Intent intent = new Intent(context, PluginInstallActivity.class)
                    .setData(androidx.core.content.FileProvider.getUriForFile(
                            context, context.getPackageName() + ".fileprovider", file))
                    .putExtra(PluginManager.EXTRA_ID, id)
                    .putExtra(PluginManager.EXTRA_VERSION, version)
                    .putExtra(PluginManager.EXTRA_PACKAGE, packageName)
