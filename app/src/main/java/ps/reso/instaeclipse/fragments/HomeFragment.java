...
public class HomeFragment extends Fragment {
    ...
    private void setupContributorsAndSpecialThanks(View rootView) {
        ...
        inflateCards(contributors, contributorsContainer); inflateCards(contributors, contributorsContainer); inflateCards(specialThanks, specialThanksContainer); inflateCards(specialThanks, specialThanksContainer);
